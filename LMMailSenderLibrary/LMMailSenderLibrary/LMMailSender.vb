...
#Region "Métodos Públicos"
    ...
    Public Sub Enviar()
        If _manejadorMensaje.From Is Nothing OrElse String.IsNullOrEmpty(_manejadorMensaje.From.Address) Then
            Dim raizRutaCarpeta As New ConfigValues("NOTIFICADORCORREO")
            Dim utenticacionCorre() As String = raizRutaCarpeta.ConfigKeyValue.Split("|")
            Dim servidorCorreo As New ConfigValues("SERVIDORCORREO")
            ...
            Else
                _manejadorMensaje.From = New MailAddress(utenticacionCorre(0) + "@logytechmobile.com", "Notificador de Eventos")
            End If
        End If
        With _clienteSmtp
