    ...
    Private Function CrearEstructuraDeDatos()
        ...
        Select Case _TipoArchivoCarga
            ...
            Case TipoArchivoCarga.DespachosRIM
                columnas = "idDespacho,codigo, cliente, serialEquipo, pin, fechaActivacion, fechaDesactivacion, fechaNacionalizacion, fechaTerminacionGarantiaProveedor, observacion, " &
                      "codigoFalla, descripcionFalla, serialCaja, referenciaPrestamo, cac, responsable, tipoCliente, identificacion, codigoMIN, telefonoFijo, email, guia, factura, valor," &
                      "nivelReparacion"
            Case Else
