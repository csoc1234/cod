            ...
            If _detalleLiberacionDespacho IsNot Nothing AndAlso _detalleLiberacionDespacho.Rows.Count > 0 AndAlso _idUsuario > 0 Then
                With dbManager
                    ...
                    Select Case resultado
                        ...
                        Case Else
                            Throw New ArgumentNullException("Error inesperado")
                    End Select
                End With
            Else
                    ...
                    With dbManager
                        ...
                        Else
                            Select Case resultadoEjecucion.Valor
                                ...
                                Case Else
                                    resultadoEjecucion.EstablecerMensajeYValor(2, "Error inesperado")
                            End Select
                        ...
                        For i As Integer = 0 To dtCambioRegion.Rows.Count - 1
                            ...
                            If rp.Valor <> 0 Then
                                Select Case rp.Valor
                                    ...
                                    Case Else
                                        rp.EstablecerMensajeYValor(2, "Error inesperado")
                                End Select
                                Exit For
                            End If
                        Next
            ...
            Try
                ...
                Or idTipoPedido = TipoPedido.Tipo.SalidaDeProductoPruebas Or idTipoPedido = TipoPedido.Tipo.DespachoCuarentena Then
                    ...
                    Select Case _resultado.Valor
                        ...
                        Case Else
                            _resultado.EstablecerMensajeYValor(2, "Error inesperado")
                    End Select
