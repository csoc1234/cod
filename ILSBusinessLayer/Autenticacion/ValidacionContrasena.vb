...
Public Class ValidacionContrasena
    Public Function validacionContrasena(ByVal pwd As String, ByVal idUsuario As Integer) As String
        ...
        With politicasContrasena
            ...
            If politicasContrasena.ValidarCantrasenaUltimosIngresos(idUsuario, SeguridadSha.EncryptPassword(pwd)) Then Return String.Concat("La contraseña no puede coincidir con las útimas ", .ValidacionUltimasContrasena.ToString(), " contraseñas")
