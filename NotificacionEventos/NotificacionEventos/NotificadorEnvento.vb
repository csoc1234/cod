...
#Region "Métodos Públicos"
    ...
    Public Sub InicializarCadenasDeTexto()
        ...
        Dim servidorCorreo As New Comunes.ConfigValues("SERVIDORCORREO")
        If raizRutaCarpeta Is Nothing AndAlso String.IsNullOrWhiteSpace(raizRutaCarpeta.ConfigKeyValue) AndAlso servidorCorreo Is Nothing Then
            Throw New ArgumentNullException("Opcion no valida")
        Else
            If String.IsNullOrEmpty(_nombreUsuario) Then _nombreUsuario = utenticacionCorre(0)
            If String.IsNullOrEmpty(_password) Then _password = utenticacionCorre(1)
            If String.IsNullOrEmpty(_dominio) Then _dominio = utenticacionCorre(2)
            If String.IsNullOrEmpty(_nombreServidor) Then _nombreServidor = servidorCorreo.ConfigKeyValue
            If String.IsNullOrEmpty(_cuentaOrigen) Then _cuentaOrigen = utenticacionCorre(0) + "@logytechmobile.com"
        End If
