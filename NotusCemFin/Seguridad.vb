    ...
    Public Shared Sub verificarSession(ByVal pagina As System.Web.UI.Page)
        Try
            ...
            If Not String.IsNullOrEmpty(pagina.Session("funcionalidadExterna")) Then
                Dim parametrosEncriptados As String
                parametrosEncriptados = pagina.Session("funcionalidadExterna").ToString

                While parametrosEncriptados.IndexOf("%") >= 0
                    parametrosEncriptados = parametrosEncriptados.Replace("%", " ")
                End While

                While parametrosEncriptados.IndexOf("¬") >= 0
                    parametrosEncriptados = parametrosEncriptados.Replace("¬", Chr(9))
                End While
                Dim parametrosDesencriptados As String
                Dim parametros As String
                Dim arrParamentros As String()
                parametrosDesencriptados = SeguridadSha.DecryptData(parametrosEncriptados, "Th1s1sAStr0ngEncryp7ionK3y123456", "Ini7ializ4ti0nV3")
