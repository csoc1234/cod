...
Public Class Login
    ...
    Protected Sub btnIngresar_Click(sender As Object, e As EventArgs) Handles btnIngresar.Click
        ...
        Dim pwd As String = SeguridadSha.EncryptPassword(txtPassword.Value)
    ...
    Private Function GenerarQuerystring(infoUsuario As Usuario) As String
        ...
        Dim dev = JsonConvert.SerializeObject(infoSesion)
        Dim datos As String = SeguridadSha.EncryptData(dev.ToString(), "Th1s1sAStr0ngEncryp7ionK3y123456", "Ini7ializ4ti0nV3")
        Return datos
    End Function
