...
Public Class Home
    ...
    Private Sub CambiarContrasena()
        ...
        Dim contrasenaEncriptadaNueva As String = SeguridadSha.EncryptPassword(txtNuevoPassword.Text.Trim)
        Dim contrasenaEncriptadaVieja As String = SeguridadSha.EncryptPassword(txtPasswordActual.Text.Trim)
